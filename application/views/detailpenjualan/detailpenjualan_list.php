...
<H2></H2>
                    <small>
		<!-- <?php echo anchor(site_url('detailpenjualan/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-primary"'); ?></small></h2> -->
...
$(document).ready(function() {
    var t =$('#datatable-buttonss').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo base_url().'index.php/detailpenjualan/data'?>"
    } );
