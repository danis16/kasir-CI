<div class="">
    ...
    <div id="list_detailretur"></div>
	    ...
	    <div class="form-group">
            ...
            <input list="nota" class="form-control" name="idPembelian" id="idPembelian" placeholder="Ketik nomor nota" value="<?php echo $idPembelian; ?>" />
                </div>
        </div>
	    <div class="form-group">
      ...
      <!--   <div class="form-group">
        ...
        <input type="hidden" id="idretur" value="<?php echo $this->uri->segment(3) ?>" /> 
...
$.ajax({
    url:'<?php echo base_url()?>index.php/returpembelian/add_detailretur_ubah',
    data: 'idretur='+idretur+'&idBarang='+idBarang+'&jumlah='+jumlah+'&kondisi='+kondisi+'&alasan='+alasan,
    success: function(){
        load();
    }
})
...
$.ajax({
    url:"<?php echo base_url()?>index.php/returpembelian/list_detailretur_ubah",
    data:"idBarang="+idBarang+"&idretur="+idretur,
...
function remove(id){
    ...
    var idBarang = $("#idBarang").val();
    $.ajax({
        url:"<?php echo base_url()?>index.php/returpembelian/remove_ubah",
        data:"id="+id,
        success:function(html){
            load();
        }
