<div class="">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input readonly="readonly" type="date" class="form-control" name="tanggal_pesan" id="tanggal_pesan" placeholder="Tanggal Pesan" value="<?php echo $tanggal_pesan; ?>" />
                </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">Nama Pelanggan <?php echo form_error('idPelanggan') ?></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            <input list="pelanggan" class="form-control" name="namaPelanggan" id="idPelanggan" placeholder="Ketik nama Pelanggan"  />
                </div>
        </div>
...
var idbarang = $("#idbarang").val();
 $.ajax({
    url:"<?php echo base_url()?>index.php/pemesan/list_barang",
