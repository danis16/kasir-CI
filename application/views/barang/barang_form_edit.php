            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">Barang <?php echo form_error('barang') ?></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input readonly="readonly" list="list_barang" type="text" class="form-control" name="barang" id="barang" placeholder="Barang" value="<?php echo $barang; ?>" />
                        </div>
                    </div>
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int" onclick="formMerek()">IdMerek <?php echo form_error('idMerek') ?></label>
<!-- 
    <button onclick="formMerek()" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Tambah Merek</button>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input readonly="readonly" list="merek_list" class="form-control" name="idMerek" id="merek" placeholder="IdMerek" value="<?php echo $idMerek; ?>" />
            </div>
        </div>
...
<!--         <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <input type="hidden" name="id" id="idBarang" value="<?php echo $this->uri->segment('3'); ?>" /> 
...
<script type="text/javascript">
    ...
    var idBarang = $("#idBarang").val();
        ...
        $.ajax({
            ...
            data:"harga="+harga+"&merek="+merek+"&idBarang="+idBarang+"&idWarna="+idWarna+"&idUkuran="+idUkuran+"&barang="+barang,
            success: function (html) {
           // $("#list").html(html);
           // alert('sukses');
           load();
...
function load () {
    ...
    $.ajax({
        ...
        data:"idWarna="+idWarna+"&idUkuran="+idUkuran+"&idBarang="+idBarang,
        success: function (html) {
         $("#list").html(html);
     }
 })
