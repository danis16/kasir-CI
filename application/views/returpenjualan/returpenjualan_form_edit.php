<div class="">
    ...
    <div id="list_detailretur"></div>
	    ...
	    <div class="form-group">
            ...
            <input list="idpenjualan" class="form-control" name="idPenjualan" id="idPenjualan" placeholder="IdPenjualan" value="<?php echo $idPenjualan; ?>" />
                </div>
        </div>
...
var idBarang=$("#idBarang").val();
$.ajax({
    url:"<?php echo base_url()?>index.php/returpenjualan/list_detailretur_edit",
    data:"idBarang="+idBarang+"&id="+id,
...
function remove(id){
    // var idBarang = $("#idBarang").val();
    $.ajax({
        url:"<?php echo base_url()?>index.php/returpenjualan/remove_ubah",
        data:"id="+id,
        success:function(html){
            load();
        }
