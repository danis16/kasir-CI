<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Pelanggan<small>different form elements</small></h2>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">NoHP <?php echo form_error('noHP') ?></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="number" class="form-control" name="noHP" id="noHP" placeholder="NoHP" value="<?php echo $noHP; ?>" />
                </div>
	    ...
	    <a href="<?php echo site_url('pelanggan') ?>" class="btn btn-default"><i class="fa fa-reply-all"></i> Cancel</a>
	</div>
                        </div></form>
     </div>
            </div>
