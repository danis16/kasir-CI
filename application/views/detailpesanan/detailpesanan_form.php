<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Detailpesanan<small>different form elements</small></h2>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">IdPemesan <?php echo form_error('idPemesan') ?></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" class="form-control" name="idPemesan" id="idPemesan" placeholder="IdPemesan" value="<?php echo $idPemesan; ?>" />
                </div>
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('detailpesanan') ?>" class="btn btn-default"><i class="fa fa-reply-all"></i> Cancel</a>
	</div>
                        </div></form>
     </div>
            </div>
