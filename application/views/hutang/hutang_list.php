...
<!-- 		<?php echo anchor(site_url('hutang/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-primary"'); ?></small></h2>
 -->
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
...
$(document).ready(function() {
    var t =$('#datatable-buttonss').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo base_url().'index.php/hutang/data'?>"
    } );
