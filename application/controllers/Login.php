...
class Login extends CI_Controller
{
    ...
    { 
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('form_login','<script>alert("Masukkan Username dan Password dengan benar")</script>');
            ...
            if ($this->session->userdata('idJabatan')=='pemilik') {
                # code...
                redirect(base_url('index.php/LaporanLaba'));
            }
            else {
    ...
    public function password_check($str)
    {
        ...
        if($user_detail->password == crypt($str,$user_detail->password)){
            ...
            $this->form_validation->set_message('password_check','<script>alert("Masukkan Username dan Password dengan benar")</script>');
            return FALSE;
        }
