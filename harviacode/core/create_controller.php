...
foreach ($all as $row){
    ...
    $string .="array(
            ...
            return anchor('$c/read/'.\$d,'<i class=\"fa fa-eye\"></i>',\"class='btn btn-sm btn-danger'\").' '.
                   anchor('$c/update/'.\$d,'<i class=\"fa fa-edit\"></i>',\"class='btn btn-sm btn-danger'\").' '.
                   anchor('$c/delete/'.\$d,'<i class=\"fa fa-trash\"></i>',\"class='btn btn-sm btn-danger'\");
                }
            )
        );
